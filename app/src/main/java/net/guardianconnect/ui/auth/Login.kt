package net.guardianconnect.ui.auth
...
import net.guardianconnect.data.Resource
...
import net.guardianconnect.navigation.ROUTE_SIGNUP
...
//        TextButton(onClick = { navController.navigate(ROUTE_FORGOTPASSWORD) }) {
